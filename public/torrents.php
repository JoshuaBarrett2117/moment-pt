...
print("    const carouselItems = carousel.querySelector('.carousel-items');");
print("    const items = carousel.querySelectorAll('.carousel-item');");
print("    const indicators = carousel.querySelectorAll('.carousel-indicator');");
...
print("    let currentIndex = 0;");
print("    const itemCount = items.length;");
print("    let slideInterval;");
print("");
print("    // 更新轮播图位置和指示器状态");
print("    function updateCarousel() {");
print("      carouselItems.style.transform = 'translateX(-' + (currentIndex * 100) + '%)';");
print("      // 更新指示器状态");
print("      indicators.forEach((indicator, index) => {");
print("        if (index === currentIndex) {");
print("          indicator.classList.add('active');");
print("          indicator.style.background = 'white';");
print("        } else {");
print("          indicator.classList.remove('active');");
print("          indicator.style.background = 'rgba(255, 255, 255, 0.5)';");
print("        }");
print("      });");
print("    }");
print("");
...
print("      currentIndex = (currentIndex + 1) % itemCount;");
print("      updateCarousel();");
print("    }");
print("");
print("    // 上一张轮播图");
print("    function prevSlide() {");
print("      currentIndex = (currentIndex - 1 + itemCount) % itemCount;");
print("      updateCarousel();");
print("    }");
print("");
print("    // 开始自动轮播");
print("    function startSlideInterval() {");
print("      slideInterval = setInterval(nextSlide, 5000); // 5秒切换一次");
print("    }");
print("");
print("    // 停止自动轮播");
print("    function stopSlideInterval() {");
print("      clearInterval(slideInterval);");
print("    }");
print("");
print("    // 事件监听器 - 上一张按钮");
print("    prevBtn.addEventListener('click', function() {");
print("      stopSlideInterval();");
print("      prevSlide();");
print("      startSlideInterval();");
print("    });");
print("");
print("    // 事件监听器 - 下一张按钮");
print("    nextBtn.addEventListener('click', function() {");
print("      stopSlideInterval();");
print("      nextSlide();");
print("      startSlideInterval();");
print("    });");
print("");
print("    // 事件监听器 - 指示器点击");
print("    indicators.forEach(indicator => {");
print("      indicator.addEventListener('click', function() {");
print("        stopSlideInterval();");
print("        currentIndex = parseInt(this.getAttribute('data-index'));");
print("        updateCarousel();");
print("        startSlideInterval();");
print("      });");
print("    });");
print("");
print("    // 鼠标悬停时停止自动轮播，移开时继续");
print("    carousel.addEventListener('mouseenter', stopSlideInterval);");
print("    carousel.addEventListener('mouseleave', startSlideInterval);");
print("");
print("    // 初始化轮播图和开始自动轮播");
print("    startSlideInterval();");
print("  });");
